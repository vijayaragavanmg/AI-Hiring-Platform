...
Reads values from the environment (populated by .env at project root).
All other layers import from here — never call os.environ directly.
...
# Load .env from project root (two levels up from this file: src/domain/ → src/ → root)
...
VECTORSTORE_PATH = Path(os.getenv("VECTORSTORE_PATH", "./resume_chroma_db"))
